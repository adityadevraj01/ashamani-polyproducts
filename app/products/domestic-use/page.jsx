...
export default function DomesticUsePage() {
  const products = [
    {
      title: "Tarpauline",
    ...
    <div className="bg-white text-green-900 min-h-screen flex flex-col">
      ...
      >
        ...
        <div className="relative z-10 text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Domestic Use Products</h1>
          <p className="max-w-3xl mx-auto text-lg">
            Discover high-quality and versatile plastic solutions tailored for everyday domestic use.
          </p>
        </div>
      </section>
      ...
      <footer className="bg-green-900 text-white px-6 md:px-20 py-10 mt-auto">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-200">✉️ info@ashmani.in</p>
          </div>
        </div>
